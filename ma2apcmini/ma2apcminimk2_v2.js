...
//config 
wing = 1;   //set wing 1, 2
pageselect = 1;   //page select mode - 0-off, 1-only action buttons, 2 - select page for action buttons and faders (use fix or autofix for faders)
            ...
            if (obj.responseSubType == 2) {//Fader LED
                if (wing == 1) {
                    ...
                    for (var i = 0; i < 5; i++) {
                        ...
                        if ((obj.itemGroups[0].items[0][i].bdC) != "#3D3D3D") {
                            m = f2;
                        }
                    ...
                    for (var i = 0; i < 3; i++) {
                        ...
                        if ((obj.itemGroups[0].items[1][i].bdC) != "#3D3D3D") {
                            m = f2;
                        }
                    ...
                    for (var i = 0; i < 5; i++) {
                        if ((obj.itemGroups[0].items[2][i].bdC) != "#3D3D3D") {
                            m = f2;
                        } else {
                            m = f1;
                        }
